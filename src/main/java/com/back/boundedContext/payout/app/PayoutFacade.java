...
public class PayoutFacade {
    ...
    private final PayoutCreatedPayoutUseCase  payoutCreatedPayoutUseCase;
    ...
    private final PayoutCompletePayoutMoreUseCase payoutCompletePayoutMoreUseCase;
    ...
    @Transactional
    public Payout createPayout(int pateeId){
        return payoutCreatedPayoutUseCase.createPayout(pateeId);
    }
    ...
    public RsData<Integer> completePayoutsMore(int limit) {
        return payoutCompletePayoutMoreUseCase.completePayoutsMore(limit);
    }
}
